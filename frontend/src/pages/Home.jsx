        ...
        <div className="step-list">
          ...
          <div className="step-item">
            ...
            <div>
              ...
              <p>The record is hashed together with the previous block's hash and stored immutably.</p>
            </div>
          </div>
          <div className="step-item">
          ...
          <div className="step-item">
            ...
            <div>
              ...
              <p>Anyone scans the QR or enters the ID on the public portal to see live, cryptographic proof of authenticity.</p>
            </div>
          </div>
        </div>
      </section>
